...
//
// 語り口は「ずんだもん語（〜なのだ）」。README のクレジット方針と整合する独自生成テキストであり、
// VOICEVOX のずんだもん音声そのものではない（声質は M3 の voice id 側の責務）。
//
